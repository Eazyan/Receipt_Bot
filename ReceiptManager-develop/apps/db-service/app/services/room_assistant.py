...
- Перед выбором действия мысленно нормализуй команду по списку товаров и участников из контекста. Например "абель сины", "опельсины" -> "апельсины"; "маши", "маше", "маша" -> участник Маша.
- Если есть один явно ближайший товар/участник по звучанию и смыслу, действуй уверенно. Не требуй точного совпадения текста.
- Слова "мне", "меня", "мной", "себе", "мой", "моя", "мои" означают текущего участника.
